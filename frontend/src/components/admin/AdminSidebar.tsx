    ...
    <>
      ...
      `}>
        <div className="mb-6 flex items-center justify-between px-2">
          ...
          <button onClick={onClose} className="text-[#4a8fa8] hover:text-[#c8f2ff] xl:hidden">✕</button>
        </div>

        <p className="mb-3 px-2 text-[10px] uppercase tracking-[0.22em] text-[#4a8fa8]">Admin Panel</p>
