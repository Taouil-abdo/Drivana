  ...
  return (
    <>
      ...
      <section className="glass-panel scan-lines fade-rise mb-4 rounded-2xl p-4 sm:p-5 flex items-start justify-between">
        ...
        <button onClick={openAdd} className="rounded-xl border border-[#2ec5f5]/40 bg-[#2ec5f5]/10 px-4 py-2 text-xs font-bold uppercase tracking-widest text-[#2ec5f5] hover:bg-[#2ec5f5]/20 transition">
          + Add Vehicle
        </button>
      </section>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="glass-panel w-full max-w-lg rounded-2xl p-6 max-h-[90vh] overflow-y-auto">
            <div className="mb-5 flex items-center justify-between">
              <h2 className="text-sm font-black uppercase tracking-widest text-[#e8fbff]">{modal === 'add' ? 'Add Vehicle' : 'Edit Vehicle'}</h2>
            ...
            <div className="mt-4 flex gap-3">
              <button onClick={() => setModal(null)} className="flex-1 rounded-xl border border-[#1e5670] py-2.5 text-xs font-bold uppercase tracking-wider text-[#7ea8bc] hover:text-[#c8f2ff] transition">Cancel</button>
